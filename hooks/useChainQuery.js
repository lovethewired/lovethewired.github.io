...
import { usePriorityAccount, usePriorityChainId, usePriorityProvider } from '../lib';
...
export function useChainQuery({ key, fetchState, initialState, initializer, chainId }) {
  ...
  const userChainId = usePriorityChainId();
